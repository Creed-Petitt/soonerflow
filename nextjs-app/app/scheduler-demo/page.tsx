  ...
  return (
    <div className="bg-amber-500/10 border-b border-amber-500/20 px-4 py-2 text-center">
      <span className="text-sm text-amber-700 dark:text-amber-400">
        📍 Demo Mode: This is the archived full scheduler view. 
        <Link href="/scheduler" className="ml-2 underline font-medium">
          View new simplified calendar →
        </Link>
      </span>
    </div>
  )
...
// The rest of the code is identical to the archived page
interface ClassData {
  id: string
  subject: string
  number: string
